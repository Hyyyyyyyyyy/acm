...
{
public:
	ZeroExcept() : Exception("ZeroExcept failed") {}
};
class FractExcept : public Exception
{
public:
	FractExcept() : Exception("FractExcept failed") {}
};
class Fract
{
public:
...
int main()
{
	...
	{
		cout << "ZeroExcept failed\n";
	}
	catch (Fract)
	{
		cout << "FractExcept failed\n";
	}
	catch (...)
	{
		cout << "Unexpected failed\n";
	}
	return 0;
}
